        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Program_AspNetUsers_FK_CoachID",
                        column: x => x.FK_CoachID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Program_AspNetUsers_FK_StudentID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgramDays", x => x.ProgramDaysID);
                    table.ForeignKey(
                        name: "FK_ProgramDays_Program_ProgramID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProgramDayMovement", x => x.ProgramDayMovementID);
                    table.ForeignKey(
                        name: "FK_ProgramDayMovement_Movement_MovementID",
                        column: x => x.MovementID,
                        principalTable: "Movement",
                        principalColumn: "MovementID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProgramDayMovement_ProgramDays_ProgramDaysID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Program_FK_CoachID",
                table: "Program",
                column: "FK_CoachID");

            migrationBuilder.CreateIndex(
                name: "IX_Program_FK_StudentID",
                table: "Program",
                column: "FK_StudentID");

            migrationBuilder.CreateIndex(
                name: "IX_ProgramDayMovement_MovementID",
                table: "ProgramDayMovement",
                column: "MovementID");

            migrationBuilder.CreateIndex(
                name: "IX_ProgramDayMovement_ProgramDaysID",
                table: "ProgramDayMovement",
